<template>
    <div id="login">
        ...
        <div class="login-box" v-if="activeMenu == 'login'">
            ...
            <button @click="login()" v-bind:class="{ disabled: loginDisabled }">
                Zaloguj się
            </button>
        ...
        <div class="login-box" v-if="activeMenu == 'register'">
            ...
            <div class="group">
                <input
                    class="inputMaterial"
                    type="password"
                    v-model="userPasswordRegisterRetry"
                    required
                />
                <span class="highlight"></span>
                <span class="bar"></span>
            ...
            <button
                @click="register()"
                v-bind:class="{ disabled: registerDisabled }"
            >
                Zarejestuj się
            </button>
