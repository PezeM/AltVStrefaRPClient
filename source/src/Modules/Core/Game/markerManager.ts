...
import {
  INetworkingMarker,
  IClientSideMarker
} from "source/src/Constans/interfaces";
...
class MarkerManager {
  ...
  constructor() {
    ...
    this.markerDistanceCheckInterval = alt.setInterval(
      this.onMarkerDistanceCheckInterval.bind(this),
      500
    );
  }
  ...
  onTickInterval() {
    for (const marker of this.markers.values()) {
      native.drawMarker(
        ...
        0,
        0,
        marker.marker.scaleX,
        marker.marker.scaleY,
        marker.marker.scaleZ,
        marker.marker.red,
        marker.marker.green,
        marker.marker.blue,
        marker.marker.alpha,
  ...
  onDataChange(entity: INetworkingEntity, changedData: INetworkingDataChange) {
    ...
    (marker.marker as any)[changedData.key] = (changedData.value as any)[
      Object.keys(changedData.value)[0]
    ];
  }
}
